...
const ResultsDisplay = ({ results, onReprocess, extractedText, onReset }) => {
  ...
  const getColor = (requestType) => {
    switch (requestType) {
      case 'summarize': return 'text-blue-600';
      case 'explain': return 'text-green-600';
      case 'quiz': return 'text-purple-600';
      case 'notes': return 'text-orange-600';
    ...
    <div className="space-y-6 animate-slide-up">
      ...
      <div className="card">
        ...
        <div className="grid sm:grid-cols-2 gap-3 mb-4">
          ...
          ].filter(option => option.type !== results.requestType).map((option) => {
